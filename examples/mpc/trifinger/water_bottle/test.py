...
from examples.mpc.trifinger.water_bottle.params import ExplicitMPCParams
from planning.mpc_explicit import MPCExplicit
from envs.trifinger_env import MjSimulator
from contact.trifinger_collision_detection import Contact
...
save_flag=False
if save_flag:
    save_dir = './examples/mpc/trifinger/water_bottle/save/'
