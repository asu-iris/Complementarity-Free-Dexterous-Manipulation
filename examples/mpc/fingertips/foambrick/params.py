...
class ExplicitMPCParams:
    def __init__(self, rand_seed=1, target_type='ground-rotation'):
        # ---------------------------------------------------------------------------------------------
        #      simulation parameters
        # ---------------------------------------------------------------------------------------------
        self.model_path_ = './envs/xmls/env_fingertips_foambrick.xml'
        ...
        if target_type == 'ground-rotation':
            ...
            target_height = 0.04 + 0.05 * np.random.rand(1)
            target_xy_rand = 0.2 * np.random.rand(2) - 0.1
        ...
        fts_q_ub = np.array([100, 100, 0.1, 100, 100, 0.1, 100, 100, 0.1])
