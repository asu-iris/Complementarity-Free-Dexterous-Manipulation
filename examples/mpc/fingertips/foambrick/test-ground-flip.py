...
from examples.mpc.fingertips.foambrick.params import ExplicitMPCParams
...
save_flag=False
if save_flag:
    save_dir = './examples/mpc/fingertips/foambrick/save-ground-flip/'
    prefix_data_name = 'ours'
    save_data = dict()
